clear all;
% 改动：1.不用accweight决定basis个数，而是直接定EffR
...
%save('Example2_8rvs_global_data_v2','U','M1','H1','-v7.3');
save('Example2_8rvs_global_Galerkin_v3','EffR','accweight','L2err_mean','H1err_mean','Engerr_mean','L2err_std','H1err_std','Engerr_std','L2proj_mean','H1proj_mean','Engproj_mean','L2proj_std','H1proj_std','Engproj_std','K2','-v7.3');
...
%save('Example2_8rvs_local_data_v2','loc_idx','M1_loc','H1_loc','time_record','time_describe','-v7.3');
save('Example2_8rvs_local_sparseInterp_v3','EffR','accweight','L2err_mean','H1err_mean','Engerr_mean','L2err_std','H1err_std','L2proj_mean','H1proj_mean','Engproj_mean','Engerr_std','L2proj_std','H1proj_std','Engproj_std','training_size','K2','-v7.3');
